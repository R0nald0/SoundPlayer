...
class MainFragment : Fragment() {
    ...
    private fun observersViewModel() {
        ...
        playListViewModel.listSize.observe(viewLifecycleOwner) { sizeListSoundOnBd ->
            binding.txvQuantidadeMusics.text =
                getString(R.string.total_de_musicas, sizeListSoundOnBd)
                ...
                when (playbackError.code) {
                    PlaybackException.ERROR_CODE_IO_FILE_NOT_FOUND -> {
                        requireView().snackBarSound(
                            ...
                            backGroundColor = Color.RED,
                            animationSnackbarMode = Snackbar.ANIMATION_MODE_FADE,
                        )
                    }
    ...
    private fun initAdapter() {
        ...
        binding.idRvPlaylist.layoutManager =
    ...
    inner class MyMenuProvider() : MenuProvider {
        ...
        override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
            ...
            if (pairPlayList.second.isEmpty()) {
                binding.txvTitleToolbar.text =
                    context?.let { ContextCompat.getString(it, R.string.app_name) }
        ...
        override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
            ...
            return when (menuItem.itemId) {
                ...
                R.id.id_update -> {
                    ...
                    val args =
                        MainFragmentDirections.actionMainFragmentToSelectPlayListDialogFragment(
                            sound
                        )
