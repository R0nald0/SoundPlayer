...
class PlayListAndSoundCrossDaoTest {
    ...
    private val playListAndSoundCrossEntities =
        listOf(
    ...
    @Test
    fun insertPlayListAndSoundCroos_save_PlayListCrossSound_on_database() =
        runTest {
            val listLongResultPlayListXSound =
                playlistAndSoundCrossDao.insertPlayListAndSoundCross(playListAndSoundCrossEntities)
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun findAllPlayListWithSong_should_return_a_PlayListWithSong() =
        runTest {
            playlistAndSoundCrossDao.insertPlayListAndSoundCross(playListAndSoundCrossEntities)
        ...
        runTest {
            val listLongResultPlayListXSound =
                playlistAndSoundCrossDao
                    .insertPlayListAndSoundCross(playListAndSoundCrossEntities)
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun deleteItemPlayListAndSoundCroos_should_delete_sound_of_playlist() =
        runTest {
            val listLongResultPlayListXSound =
                playlistAndSoundCrossDao
                    .insertPlayListAndSoundCross(playListAndSoundCrossEntities)
            println("values inserted = $listLongResultPlayListXSound")
            val result = playlistAndSoundCrossDao.deleteItemPlayListAndSoundCross(3, 7)
            assertThat(result).isEqualTo(1)
        }

    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun findSoundByNameAndSoundId_should_find_all_sounds_title() =
        runTest {
            val playList =
                PlayListEntity(
                    playListId = 1,
            ...
            val playListAndSoundCrossEntities =
                listOf(
                    PlayListAndSoundCrossEntity(playListId = 2L, soundId = 3L),
                    PlayListAndSoundCrossEntity(playListId = 2L, soundId = 4L),
