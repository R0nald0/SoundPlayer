...
object HelperDataTest {
    ...
    fun playlistWithSoundDomainList() =
        List(10) {
            PlaylistWithSoundDomain(
                soundOfPlayList = mutableSetOf(),
                playList =
                    PlayList(
                        idPlayList = null,
    ...
    fun listPlayListAndSoundCrossEntity() =
        listOf(
    ...
    fun listSound() =
        mutableSetOf(
            ...
            Sound(
                ...
                uriMediaAlbum = "",
                uriMedia = "",
                insertedDate = 2313239,
            ),
        )

    fun listOfPlayListEtity() =
        listOf(
            PlayListEntity(
                playListId = 1,
