...
class SoundRepositoryTest {
    ...
    @Test
    fun given_sound_when_saveSound_is_executed_should_save_sound_and_return_id() =
        runTest {
            val sound =
                Sound(
                    idSound = 32,
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun given_sound_when_deleteSound_is_executed_should_delete_sound_and_return_number_of_lines_correctly_deleted() =
        runTest {
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `Given sound title,When findSoundByName is executed,should find a flow of list of sound with title`() =
        runTest {
            val flowOfSoundEntity =
                flow<SoundEntity> {
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `Given a String,When findSoundById is executed,should find a sound `() =
        runTest {
    ...
    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `When findAllSound is executed,should return a list of sounds`() =
        runTest {
